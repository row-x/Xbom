...
def update():
    try:
        ...
        toolVersion = "NahidHasan"
    
    try:
        mainVersion = requests.get("https://github.com/NAHID-AFRIDY/Xbom/blob/main/more/version").text
    except:
    ...
    os.system("cd .. && rm -rf XBom && git clone https://github.com/NAHID-AFRIDY/Xbom > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd Xbom && python xbom.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : NAHID HASAN                     \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/NAHID-AFRIDI \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : NAHID AFRIDI              \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
